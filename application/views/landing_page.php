            ...
            <div class="layer">
               <div class="row Section">
                  <div class="col">
                     <div class="box">
                        <div>
                           <h2>Koperasi Karyawan <br> Bukopin Karawang</h2>
                        </div>
                        <p>aplikasi ini dibuat untuk membantu koperas karyawan bukopin dalam proses penggajian karyawan</p>
                     </div>
                  </div>
                  ...
                  <div class="team-memeber col-md-6 col-lg-4 col-xl-3">
                     <div class="card">
                        ...
                        <div class="TeamInfo text-center">
                           <div class="Name">Erda Melinia Kartika
                           <div class="Job">Sistem Informasi Akuntansi</div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-12 text-center my-3">
                  Copyright &copy; Erda Melinia Kartika| Penggajian 2023 - All Rights Reserved
               </div>
            </div>
         </div>
      </div>
