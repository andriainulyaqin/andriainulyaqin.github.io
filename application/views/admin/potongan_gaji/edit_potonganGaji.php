<form method="post" id="form">
    <div class="form-group">
        ...
        <input type="text" class="form-control" value="<?php echo $hasil->potongan; ?>" name="potongan_baru" placeholder="Masukkan Potongan">
    </div>
    <div class="form-group">
         <label for="jml_potongan">Jumlah Potongan</label>
        <input type="text" class="form-control" value="<?php echo $hasil->jml_potongan; ?>" name="jml_potongan" placeholder="Masukkan Jumlah Potongan" >
    </div>
